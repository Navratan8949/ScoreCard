                        ...
                        <div className="row justify-content-center">
                            <div className="col-xl-9">
                                <div className="slider-content text-center">
                                    ...
                                    <h2 className="tlt fix" data-in-effect="fadeInLeft">15% Welcome Bouns on New ID  <span>5% Lifetime Bouns</span></h2>
                                ...
                                <div style={{ background: "#FFE4C9" }} className="game-single-content">
                                    <div className="upcoming-game-head">
                                        <div className="uc-game-head-title">
                                            <h4>welcome in The Family of <span style={{ color: "red" }}>ScoreCard "Khelo Dil and Dimag Se" - Oldest Fantasy Sports provider</span></h4>
                                        </div>
